import copycss from './copy.module.css'
export default function Copyright() {
    return <div className={copycss.section}>
        <div className={copycss.wrapper}>
            <p>&copy; Copyright 2022 - Ambicorspace Interior Design Website by <a href='webaccuracy.com'>webaccuracy.com</a></p>
            <div>
                <a href='https://www.facebook.com/ambicorspace/' target='_blank'>
                    <div className={copycss.svgContainer}>
                ...
                <a href='https://api.whatsapp.com/send/?phone=918605183887&text&type=phone_number&app_absent=0' target='_blank'>
                ...
                <a href='https://www.instagram.com/ambicorspace/' target='_blank'>
